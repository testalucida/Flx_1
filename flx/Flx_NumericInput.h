...
public:
	...
	my::Signal< Flx_NumericInput, ActionParm > signalEnterKey;
    my::Signal< Flx_NumericInput, ActionParm > signalTabKey;
...
//    void callback();
    bool hasFocus() const;
private:
    void onChanged( Flx_Input&, ActionParm & );
    void onEnter( Flx_Input&, ActionParm & );
    void onTab( Flx_Input&, ActionParm & );
private:
    Flx_Input *_pInp;
    Flx_Box   *_pBox;
};
